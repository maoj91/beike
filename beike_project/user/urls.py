...
urlpatterns = patterns('',
	...
	url(r'^get_info/get_location_by_latlong$', views.get_and_create_location_by_latlong),
	url(r'^get_info/get_location_by_zipcode$', views.get_and_create_location_by_zipcode),
